    ...
    return function() {
      ...
      var t = {
          ...
          853: function(t, e, i) {
              ...
              fn: function(t) {
                ...
                Object.keys(e.elements).forEach((function(t) {
                  var i = e.styles[t] || {},
                    n = e.attributes[t] || {},
                    o = e.elements[t];
                  P(o) && k(o) && (Object.assign(o.style, i), Object.keys(n).forEach((function(t) {
                    var e = n[t];
                ...
                return Object.assign(e.elements.popper.style, i.popper), e.styles = i, e.elements.arrow && Object.assign(e.elements.arrow.style, i.arrow),
                  function() {
                    Object.keys(e.elements).forEach((function(t) {
                      ...
                      P(n) && k(n) && (Object.assign(n.style, r), Object.keys(o).forEach((function(t) {
                        n.removeAttribute(t)
                      })))
                    }))
                  }
            ...
            function et(t) {
              ...
              if (h) {
                var k = Y(i),
                  j = "clientHeight",
                  P = "clientWidth";
                if (k === T(i) && "static" !== R(k = N(i)).position && "absolute" === p && (j = "scrollHeight", P = "scrollWidth"), c === n || (c === s || c === r) && l === d) x = o, b -= (v && k === A && A.visualViewport ? A.visualViewport.height : k[j]) - a.height, b *= f ? 1 : -1;
                if (c === s || (c === n || c === o) && l === d) L = r, y -= (v && k === A && A.visualViewport ? A.visualViewport.width : k[P]) - a.width, y *= f ? 1 : -1
              }
              ...
              return y = I.x, b = I.y, f ? Object.assign({}, S, ((C = {})[x] = O ? "0" : "", C[L] = E ? "0" : "", C.transform = (A.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + b + "px)" : "translate3d(" + y + "px, " + b + "px, 0)", C)) : Object.assign({}, S, ((e = {})[x] = O ? b + "px" : "", e[L] = E ? y + "px" : "", e.transform = "", e))
            }
            var it = {
                name: "computeStyles",
                enabled: !0,
            ...
            function pt(t) {
              return ["html", "body", "#document"].indexOf(k(t)) >= 0 ? t.ownerDocument.body : P(t) && ut(t) ? t : pt(U(t))
            }
            ...
            var _t = {
              ...
              fn: function(t) {
                ...
                if (!e.modifiersData[d]._skip) {
                  for (var u = i.mainAxis, p = void 0 === u || u, f = i.altAxis, h = void 0 === f || f, m = i.fallbackPlacements, y = i.padding, _ = i.boundary, b = i.rootBoundary, w = i.altBoundary, E = i.flipVariations, O = void 0 === E || E, L = i.allowedAutoPlacements, x = e.options.placement, A = I(x), k = m || (A === x || !O ? [st(x)] : function(t) {
                      if (I(t) === a) return [];
                      var e = st(t);
                      return [ct(t), e, ct(e)]
                    }(x)), T = [x].concat(k).reduce((function(t, i) {
            ...
            function At(t, e, i) {
              ...
              return (r || !r && !i) && (("body" !== k(e) || ut(a)) && (l = (n = e) !== T(n) && P(n) ? {
            ...
            var Ct = Pt(),
              St = Pt({
                defaultModifiers: [ot, Lt, it, S, Ot, _t, xt, Z, Et]
              }),
              It = Pt({
                defaultModifiers: [ot, Lt, it, S]
              })
          },
          902: function(t, e) {
          ...
          16: function(t, e) {
            ...
            var n = {
                placement: "center",
                backdropClasses: "backdrop-modal bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40",
                backdrop: "dynamic",
                closable: !0,
                onHide: function() {},
                onShow: function() {},
